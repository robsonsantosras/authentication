...
import boasentregas.user.filter.TokenAuthenticationFilter;
import boasentregas.user.repositories.UserRepository;
import boasentregas.user.services.implement.AuthenticationService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers(HttpMethod.POST, "/oauth/v1/token").permitAll()
